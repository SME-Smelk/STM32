/**
  ******************************************************************************
  * @Project        : FreeRTOS_03-LedButton
  * @Autor          : Ismael Poblete
  * @Company		: -
  * @Date         	: 02-23-2021
  * @Target			: DISCOVERY-DISC1 STM32F407VG
  * @brief          : FreeRTOS task programming with led and button.
  ...
  * 		2-task_button_handler: Read the value of the button and put it in led.
  ******************************************************************************
**/
...
int main(void)
{
	...
	//tarea 2
	xTaskCreate(task_button_handler,"Button",configMINIMAL_STACK_SIZE,NULL,1,NULL);
