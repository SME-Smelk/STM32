...
//Funcion que habilita el stack de memoria de las tareas
void init_tasks_stack(void);
//Funcion que habilita las fallas del procesador
void enable_processor_faults(void);

//Funcion para cambiar SP a PSP
__attribute__((naked)) void switch_sp_to_psp(void);

//Para adquirir el valor de PSP
uint32_t get_psp_value(void);

//Variable que selecciona cada tarea, mientras incrementa su valor
