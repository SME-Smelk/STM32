...
void configure_priority_for_irqs(uint8_t irq_no, uint8_t priority_value)
{
	...
	//Muevo direccion en la cantidad de iprx
	//Cada direccion representa un conjunto 4bytes 1hex
	//00 a 04 hay 4 bytes 32 bits.
	/**Ej: Direccion
	 * 0xE000E400 + 0 = 0xE000E400
	 * 0xE000E400 + 1 = 0xE000E404
	 * 0xE000E400 + 7 = 0xE000E41C
	 * */
